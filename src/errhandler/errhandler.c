...
/**
 * @brief Load source code from a file and set it for error display.
 *        The source lines are copied internally (copy_source_lines is enabled).
 * @param filename  Path to the source file.
 * @return 0 on success, -1 on error (file not found or out of memory).
 */
